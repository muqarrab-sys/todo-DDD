import { GenderEnum, IUserCredentialsValidation, IUserValidationObject } from '@/domain/entities/user/types';
import Email from '@/domain/ValueObjects/Email';
import Password from '@/domain/ValueObjects/Password';
import { Transform, Type } from 'class-transformer';
import { IsDate, IsEnum, IsString, ValidateNested } from 'class-validator';

export class UserCreationValidation implements IUserValidationObject {
